  ...
  let pricings = [
    {
      ...
      imgHeight: 100,
      monthlyPrice: 0,
      currentPlan: auth?.user?.plan && auth?.user?.plan?.plan == 'free' ? true : auth?.user?.plan && auth?.user?.plan?.plan == 'regular' ? false : false,
      popularPlan: false,
    ...
    },
    {
      ...
      title: 'Captain',
      popularPlan: true,
      currentPlan: auth?.user?.plan && auth?.user?.plan?.plan == 'free' ? false : auth?.user?.plan && auth?.user?.plan?.plan == 'regular' ? true : false,
