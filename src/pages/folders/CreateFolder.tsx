...
const CreateFolder = (props: any) => {
  ...
  const handleSubmit = () => {
    ...
    LoginRegistrationAPI.createFolder({ name: name }).then(res => {
      setLoading(false)
      if (res.status == 201) {
  ...
  return (
    <>
      ...
      <div style={{ height: "100%" }}>
        <Button variant='contained' startIcon={<Icon icon="mdi:folder-plus-outline" />} onClick={e => {
          setShow(true);
      ...
      >
        ...
        >
          ...
          <Button variant='contained' startIcon={<Icon icon={loading ? "line-md:loading-twotone-loop" : "mdi:create-new-folder-outline"}></Icon>} onClick={handleSubmit}>Create</Button>
