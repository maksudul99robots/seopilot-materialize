import { Box, Card, Typography, CardContent, CardHeader, Collapse, IconButton } from '@mui/material'
// ** MUI Imports
...
export default function AiScoreComponent(props: any) {
    ...
    return (
        ...
        <Card sx={{ border: "1px solid #EBEBEF", borderRadius: "10px", marginTop: "10px", padding: "10px" }}>
