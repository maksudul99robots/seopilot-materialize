    ...
    return (
        <div ref={setNodeRef} style={style} {...attributes} className="aiwriter-inputs">
            ...
            <div style={{ padding: "10px", display: "flex", justifyContent: "spece-between", width: "100%" }}>
                ...
                <select key={makeid()} name="cars" style={{ border: "none" }} onChange={e => { props.changeListicleOutlineTag(props.index, e.target.value) }}>
                ...
                <div style={{ width: "45%", paddingRight: "5px" }}>
                    <input key={makeid()} style={{ width: "100%", height: "45px", borderRadius: "5px", paddingLeft: "5px", backgroundColor: "#fff", color: "#333333", border: "1px solid #D8D8DD" }} defaultValue={props.id.substring(8, props.id.length) ? props.id.substring(3, props.id.length) : ''} id={props.index}
