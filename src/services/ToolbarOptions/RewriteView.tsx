...
const ListOfRewrites = (props: any) => {
    // ** States
    ...
    return (
        <>
            <Button variant='text' onClick={e => setShow(true)} sx={{ marginLeft: "5px" }} startIcon={<Icon icon="f7:wand-stars-inverse" />}>List of Rewrites</Button>
            ...
            >
                ...
                >
                    ...
                    <Button variant='contained' startIcon={<Icon icon={loading ? "line-md:loading-twotone-loop" : "f7:wand-stars-inverse"}></Icon>}>Rewrite</Button>
