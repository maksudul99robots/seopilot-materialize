            ...
            <CardContent sx={{ mt: 5 }}>
              <Grid container spacing={6}>
                ...
                <Grid item xs={12} sx={{ mb: 10 }}>
                  ...
                  <Button type='reset' variant='outlined' color='secondary' onClick={() => resetValue()}>
                    Reset
                  </Button>
                </Grid>
              </Grid>
      ...
      <Dialog fullWidth maxWidth='xs' open={open} onClose={handleClose}>
        ...
        >
          ...
          >
            ...
            <Typography>Are you sure you would like to cancel deactive your account?</Typography>
          </Box>
        </DialogContent>
        <DialogActions
          sx={{
      ...
      <Dialog fullWidth maxWidth='xs' open={secondDialogOpen} onClose={handleSecondDialogClose}>
        ...
        >
          ...
          >
            ...
            <Typography>
              {userInput === 'yes' ? 'Your Account is deactivated successfully.' : 'Deactivation Cancelled!!'}
            </Typography>
          </Box>
        </DialogContent>
        <DialogActions
